<template>
  <div>
    <el-form :inline="true">
      ...
      <el-form-item>
        <el-popconfirm title="Are you sure want to delete" @confirm="delHandle(null)">
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-button type="text" @click="permHandle(scope.row.id)">AssignPerm</el-button>
...
export default {
  ...
  methods: {
    ...
    handleSizeChange(val) {
      console.log(`${val} records each page`);
      this.size = val
      this.getRoleList()
    },
