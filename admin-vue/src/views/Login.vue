<template>
  <el-row type="flex" class="row-bg" justify="center">
    <el-col :xl="6" :lg="7">
      <h2>Welcome to VueAdmin System</h2>
      <el-image :src="require('@/assets/me.jpg')" style="height: 180px; width: 180px;"></el-image>

      <p>Scan to add my WeChat</p>
      <p>username:admin, password:111111</p>
    ...
    return {
      ...
      rules: {
        ...
        code: [
          ...
          { min: 5, max: 5, message: 'Length is 5', trigger: 'blur' }
        ],
      },
      captchaImg: null
    };
